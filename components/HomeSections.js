            ...
            <Col lg={6} sm={6} className="model-card">
              <div className="user-interact-inner">
                ...
                <ul>
                  ...
                  <li>
                    <strong>{t("mining.init")}</strong>
                    {t("mining.init-text")}
                  </li>
                  <li>
                    <strong>{t("mining.model")}</strong>
                    {t("mining.model-text")}
                  </li>
                  <li>
                    <strong>{t("mining.method")}</strong>
                    {t("mining.method-text1")}
                  </li>
                </ul>
              </div>
            </Col>
            <Col lg={6} sm={6} className="model-card">
              <div className="user-interact-inner">
                ...
                <ul>
                  ...
                  <li>
                    <strong>{t("governance.total")}</strong>
                    {t("governance.total-text")}
                  </li>
                  <li>
                    <strong>{t("governance.model")}</strong>
                    {t("governance.model-text-1")}
                  </li>
                  <li>
                    <strong>{t("governance.method")}</strong>
                    {t("governance.method-text")}
                  </li>
                </ul>
              </div>
            </Col>
