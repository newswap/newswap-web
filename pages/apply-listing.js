...
const PostDetails = () => {
  ...
  return (
    <Layout
      pageTitle={
        t("pages.apply-listing") + " - " + t("global.site title")
      }
                ...
                <div className="single-post-inner">
                  <div className="post-content">
                    <div className="post-details">
                      ...
                      <h4>English</h4>
                      <p>
                        NewSwap is a decentralized trading protocol
                        based on Newton's public chain NewChain, which
                        realizes fast and safe exchange between NEW
                        and NRC6 tokens issued based on NewChain, and
                        between NRC6 tokens. After passing the review,
                        the applicant will receive the listing
                        information email, and can create a trading
                        pair on NewSwap. Finally, the review will be
